   ...
   const handleSubmit = async (e) => {
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        {!hasVariants ? (
                            ...
                            <div className="mb-4">
                                ...
                                <div className="d-flex gap-2 mb-3">
                                    <button type="button" onClick={handleAddVariant} className="btn btn-sm btn-brand">
                        ...
                        <div className="mb-4">
                            ...
                            <div className="row g-2 mb-3">
                                ...
                                <div className="col-md-2 d-flex gap-2">
                                    <button type="button" onClick={handleAddAddon} className="btn btn-sm btn-brand">
                        ...
                        <div className="row g-3 mb-4">
                            <div className="col-md-6">
                                ...
                                <div className="d-flex gap-2 mb-2">
                                    ...
                                    />
                                    <button type="button" onClick={handleAddIncludedItem} className="btn btn-sm btn-brand">Add</button>
                                </div>
                            ...
                            <div className="col-md-6">
                                ...
                                <div className="d-flex gap-2 mb-2">
                                    ...
                                    />
                                    <button type="button" onClick={handleAddExcludedItem} className="btn btn-sm btn-brand">Add</button>
                                </div>
                        ...
                        <div className="mb-4">
                            ...
                            <div className="row g-2 mb-3">
                                ...
                                <div className="col-md-2 d-flex gap-2">
                                    <button type="button" onClick={handleAddFaq} className="btn btn-sm btn-brand">
                                ...
                                <div className="mb-2">
                                    ...
                                    {featuredImage && (
                                        <div className="mt-2">
                                            ...
                                            />
                                            <span className="ms-2 text-success">✓ {featuredImageFile ? 'New file selected' : 'Current image'}</span>
                                        </div>
                                    )}
                                </div>
                                <input
                            ...
                            <div className="col-md-6">
                                ...
                                <div className="row g-2 mb-2">
                                    ...
                                    <div className="col-auto d-flex gap-1">
                                        <button type="button" onClick={handleAddGalleryItem} className="btn btn-sm btn-brand">
                        ...
                        <div className="row g-3 mb-4">
                            <div className="col-md-6">
                                ...
                                <div className="row g-2 mb-2">
                                    ...
                                    <div className="col-auto">
                                        <button type="button" onClick={handleAddRequirement} className="btn btn-sm btn-brand">Add</button>
                                    </div>
                                </div>
                            ...
                            <div className="col-md-6">
                                ...
                                <div className="row g-2 mb-2">
                                    ...
                                    <div className="col-auto">
                                        <button type="button" onClick={handleAddTool} className="btn btn-sm btn-brand">
                        ...
                        <div className="mb-4">
                            <h6 className="fw-bold border-bottom pb-2">
                                <FaList className="me-2" style={{ color: "#A5732F" }} />Our Process Steps
                            </h6>
                                        ...
                                        return (
                                            <div key={i} className="col-md-4">
                                                <div className="card border-0 shadow-sm rounded-3 h-100" style={{ borderTop: '3px solid #1a1a1a' }}>
                                                    {previewSrc && (
                                                        processStepImageFiles[i] ? (
                                                            /* local blob – plain img is fine, no network latency */
                                                            <img
                                                                src={previewSrc}
                                                                alt={step.title}
                                                            ...
                                                            /* remote API image – use AdminImage */
                                                            <AdminImage
                                                                src={previewSrc}
                                                                alt={step.title}
                                                                width="100%"
                                                                ...
                                                                imgClassName="card-img-top rounded-top-3"
                                    ...
                                    <tr key={svc._id}>
                                        ...
                                        <td>
                                            <div className="fw-semibold">
                                                <FaLayerGroup style={{ color: "#A5732F" }} className="me-2" />
                                                {svc.name}
                                                {svc.hasVariants && (
    ...
    try {
        ...
        return null;
                                        ...
                                        <td className="fw-bold" style={{ color: "#A5732F" }}>{getDisplayPrice(svc)}</td>
                                        <td>
                                        ...
                                        <td>
                                            <div className="d-flex gap-1">
                                                <button onClick={() => handleOpenEdit(svc)} className="btn btn-sm btn-light border" style={{ color: "#A5732F" }} title="Edit"><FaEdit /></button>
