...
const styles = {
    ...
    completedBadge: { backgroundColor: '#A5732F' },
    ...
    btnPrimary: { width: '100%', backgroundColor: '#A5732F', color: '#fff', border: 'none', borderRadius: 8, padding: '14px', fontWeight: 600, fontSize: 15, letterSpacing: 0.5, cursor: 'pointer', marginTop: 12, marginBottom: 8 },
