        ...
        <div style={{ maxWidth: 1100, margin: '0 auto', padding: '48px 20px', display: 'grid', gridTemplateColumns: '1fr 280px', gap: 40, alignItems: 'start' }}>
            ...
            <div>
                ...
                <p style={{ fontSize: '14px', lineHeight: 1.8, color: '#333', marginBottom: 16 }}>
                    ...
                    <a href="/privacy-policy" style={{ color: '#2e7d32' }}>https://1app.com/privacy-policy</a>{' '}
                ...
                <div style={{ border: '1px solid #e0e0e0', borderRadius: 12, padding: '20px', marginBottom: 16 }}>
                    ...
                    {SECTIONS.map(sec => (
                        <div key={sec.id}
                            ...
                            style={{ fontSize: '13px', padding: '6px 0', cursor: 'pointer', color: active === sec.id ? '#2e7d32' : '#444', fontWeight: active === sec.id ? 700 : 400, borderLeft: active === sec.id ? '2px solid #2e7d32' : '2px solid transparent', paddingLeft: 10, marginBottom: 2 }}>
                            {sec.title}
                        </div>
                    ))}
                </div>
