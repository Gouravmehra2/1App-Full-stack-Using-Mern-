        ...
        <div style={{ maxWidth: 1200, margin: '0 auto', padding: '40px 20px', display: 'grid', gridTemplateColumns: '160px 1fr 260px', gap: 32, alignItems: 'start' }}>
                ...
                <div>
                    ...
                    {LANGUAGES.map(l => (
                        <div key={l} onClick={() => setActiveLang(l)}
                            style={{ fontSize: '13px', padding: '4px 0', cursor: 'pointer', color: activeLang === l ? '#2e7d32' : '#666', fontWeight: activeLang === l ? 700 : 400 }}>
                            {l}
                        </div>
                    ))}
                </div>
            ...
            <div>
                ...
                <p style={{ fontSize: '14px', lineHeight: 1.8, color: '#333', marginBottom: 12 }}>
                    ...
                    <a href="https://www.1appcompany.com/" style={{ color: '#2e7d32' }}>https://www.1appcompany.com/</a>{' '}
                ...
                <p style={{ fontSize: '14px', lineHeight: 1.8, color: '#333', marginBottom: 24 }}>
                    ...
                    <a href="/terms" style={{ color: '#2e7d32' }}>https://www.1appcompany.com/terms</a>{' '}
            ...
            <div style={{ position: 'sticky', top: 80 }}>
                <div style={{ border: '1px solid #e0e0e0', borderRadius: 12, padding: '20px', marginBottom: 16 }}>
                    ...
                    {SECTIONS.map(sec => (
                        <div key={sec.id} onClick={() => scrollTo(sec.id)}
                            style={{ fontSize: '12px', padding: '5px 0 5px 10px', cursor: 'pointer', color: active === sec.id ? '#2e7d32' : '#444', fontWeight: active === sec.id ? 700 : 400, borderLeft: active === sec.id ? '2px solid #2e7d32' : '2px solid transparent', marginBottom: 2 }}>
                            {sec.title}
                        </div>
                    ))}
                </div>
                <div style={{ border: '1px solid #e0e0e0', borderRadius: 12, padding: '20px' }}>
                    ...
                    <a href="/contact" style={{ display: 'block', background: '#111', color: '#fff', textAlign: 'center', padding: '12px', borderRadius: 8, fontWeight: 700, fontSize: '14px', textDecoration: 'none' }}>Contact Support</a>
                </div>
            </div>
        </div>
    );
