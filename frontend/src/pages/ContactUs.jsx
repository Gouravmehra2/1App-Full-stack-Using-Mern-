        ...
        <div style={{ maxWidth: 1100, margin: '0 auto', padding: '48px 20px', display: 'grid', gridTemplateColumns: '1fr 420px', gap: 48, alignItems: 'start' }}>
            ...
            <div>
                ...
                <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
                    ...
                    <button type="submit" disabled={submitting}
                        style={{ background: '#2e7d32', color: '#fff', border: 'none', borderRadius: 8, padding: '14px 32px', fontWeight: 700, fontSize: '15px', cursor: 'pointer', width: 'fit-content' }}>
            ...
            <div>
                <InfoCard title="Need help?">
                    ...
                    <a href="#" style={{ color: '#2e7d32', fontWeight: 700, fontSize: '14px', textDecoration: 'none' }}>Open Help Center &rsaquo;</a>
                </InfoCard>
                ...
                <InfoCard title="Our office addresses">
                    ...
                    <a href="#" style={{ color: '#2e7d32', fontWeight: 700, fontSize: '14px', textDecoration: 'none' }}>View addresses &rsaquo;</a>
                </InfoCard>
            </div>
        </div>
    );
